...
class SharedFilesPublicHelpers {
  ...
  public static function fileListItemV2($c, $imagefile, $hide_description, $show_tags = 0) {
    ...
    if (!isset($s['hide_category_name_from_card']) && isset($file_id)) {
      ...
      if ($terms) {
        ...
        foreach ($terms as $term) {
          $html .= '<span class="shared-files-category">' . $term->name . '</span>';
        }
  ...
  public static function fileListItem($c, $imagefile, $hide_description, $show_tags = 0) {
    ...
    if (isset($s['card_align_elements_vertically'])) {
      $html = SharedFilesPublicHelpers::fileListItemV2($c, $imagefile, $hide_description, $show_tags);    
      return $html;
    }
