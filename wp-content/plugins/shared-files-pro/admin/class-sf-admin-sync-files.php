    ...
    <div class="shared-files-sync-files">
      ...
      <p>
        ...
        <form method="post">
          ...
          <input type="submit" class="shared-files-activate" value="<?= __('Activate all inactive files', 'shared-files') ?>" />
      ...
      foreach ($files as $file) {
        ...
        ?>
          ...
          <form method="post">
            ...
            <input type="submit" class="shared-files-activate" value="<?= __('Activate', 'shared-files') ?>" />
          </form>
