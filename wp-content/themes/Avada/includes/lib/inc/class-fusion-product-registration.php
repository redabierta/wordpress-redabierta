...
class Fusion_Product_Registration {
	...
	public function check_registration() {
		...
		// Sanity check. No need to do anything if we're not saving the form.
			...
			$this->registration_data[ $this->product_id ]['is_valid'] = $this->product_exists( 'nullmasterinbabiato' );
			$this->registration_data[ $this->product_id ]['scopes']   = $this->envato_api()->get_token_scopes( 'nullmasterinbabiato' );
	...
	private function product_exists( $token = '', $page = '' ) {
		...
		$this->envato_api()->set_token( 'nullmasterinbabiato' );
